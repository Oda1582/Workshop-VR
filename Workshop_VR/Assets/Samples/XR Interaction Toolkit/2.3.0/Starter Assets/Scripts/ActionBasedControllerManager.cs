...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The reference to the action of changing the flashlight mode.")]
        InputActionReference m_FlashlightMode;
        ...
        void SetupInteractorEvents()
        {
            ...
            {
                // If activated it'll block all locomotions control, cf line 107
            ...
            // var FlashlightMode = GetInputAction(m_FlashlightMode);
